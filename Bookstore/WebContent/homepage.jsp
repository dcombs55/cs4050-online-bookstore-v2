...
<body>
	...
	<main>
		<div class="navbar">
			...
			<a href = "admin_hp.jsp">*DEMO ADMIN ACCESS*</a>
			<div class ="search">
...
%>
			...
			<div class= "row">
				<div class= "column">
					<tr id>
						<td><a href ="EditBook.jsp?u=<%=rs1.getString("BookID")%>"><div id="book"><img border="0" src="<%=rs1.getString("PictureURL")%>" width="125" height="200"></div></td>
					</tr>
					<tr id ="booktitle">
				...
				<div class= "column">
					<tr>
						<th><a href = "EditBook.jsp?u=<%=rs1.getString("BookID")%>"><div id="book"><img border="0" src="<%=rs1.getString("PictureURL")%>" width="125" height="200"></div></th>
					</tr>
					<tr id ="booktitle">
						<td><a style="text-decoration:none; color:black"><%=rs1.getString("BookName")%></a></td>
					</tr>
	...
	%>
		<div style="text-align:center;"><a href="AllBooksHome.jsp" class="catalog">View Full Catalog</a></div>
	<main>
