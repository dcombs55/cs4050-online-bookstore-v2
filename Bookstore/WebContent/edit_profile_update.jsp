...
ps1.setString(2,w);
ps1.executeUpdate();
String s2 = "update Bookstore.Address set Street=?,City=?,State=? where Customer_UserID= " + "'" + user+ "'";
PreparedStatement ps2 =connection.prepareStatement(s2);
ps2.setString(1,e);
ps2.setString(2,r);
ps2.setString(3,t);
ps2.executeUpdate();
String s3 = "update Bookstore.CreditCard set CardNum=?,ExpDate=?,CCV=? where UserID= " + "'" + user+ "'";
